    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    docRef = firebase_1.db.collection("anime").doc(episodeInfo.animeName).collection("episodes").doc(episodeInfo.episode.toString());
                ...
                case 1:
                    ...
                    if (doc.exists) {
                        ...
                        return [2 /*return*/, null]; // Return null if the document doesn't exist
                    }
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
